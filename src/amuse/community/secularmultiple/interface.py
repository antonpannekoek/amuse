...
class SecularMultipleInterface(CodeInterface):
    ...
    def add_particle():
        ...
        function.addParameter(
            "index_of_the_particle", dtype="int32", direction=function.OUT, unit=INDEX
        )
        function.addParameter(
            "is_binary", dtype="bool", direction=function.IN, unit=NO_UNIT
        )
        function.addParameter(
            "is_external", dtype="bool", direction=function.IN, unit=NO_UNIT
        )
    ...
    def delete_particle():
        function = LegacyFunctionSpecification()
        function.addParameter(
            "index_of_the_particle", dtype="int32", direction=function.IN, unit=INDEX
        )
        function.result_type = "int32"
        return function
    ...
    def set_children():
        ...
        function.addParameter(
            "child1", dtype="int32", direction=function.IN, unit=LINK("particles")
        )
        function.addParameter(
            "child2", dtype="int32", direction=function.IN, unit=LINK("particles")
        )
        function.result_type = "int32"
        return function
    ...
    def get_children():
        ...
        function.addParameter(
            "child1", dtype="int32", direction=function.OUT, unit=LINK("particles")
        )
        function.addParameter(
            "child2", dtype="int32", direction=function.OUT, unit=LINK("particles")
        )
        function.result_type = "int32"
        return function
    ...
    def set_mass():
        ...
        function.addParameter(
            "mass", dtype="float64", direction=function.IN, unit=unit_m
        )
        function.result_type = "int32"
        return function
    ...
    def get_mass():
        ...
        function.addParameter(
            "mass", dtype="float64", direction=function.OUT, unit=unit_m
        )
        function.result_type = "int32"
        return function
    ...
    def set_mass_dot():
        ...
        function.addParameter(
            "mass_dot", dtype="float64", direction=function.IN, unit=unit_m / unit_t
        )
        function.result_type = "int32"
        return function
    ...
    def get_mass_dot():
        ...
        function.addParameter(
            "mass_dot", dtype="float64", direction=function.OUT, unit=unit_m / unit_t
        )
        function.result_type = "int32"
        return function
    ...
    def set_radius():
        ...
        function.addParameter(
            "radius", dtype="float64", direction=function.IN, unit=unit_l
        )
        function.addParameter(
            "radius_dot_external",
            dtype="float64",
    ...
    def get_radius():
        ...
        function.addParameter(
            "radius", dtype="float64", direction=function.OUT, unit=unit_l
        )
        function.addParameter(
            "radius_dot_external",
            dtype="float64",
    ...
    def get_level():
        ...
        function.addParameter(
            "level", dtype="int32", direction=function.OUT, unit=NO_UNIT
        )
        function.result_type = "int32"
        return function
    ...
    def set_spin_vector():
        ...
        function.addParameter(
            "spin_vec_x", dtype="float64", direction=function.IN, unit=1.0 / unit_t
        )
        function.addParameter(
            "spin_vec_y", dtype="float64", direction=function.IN, unit=1.0 / unit_t
        )
        function.addParameter(
            "spin_vec_z", dtype="float64", direction=function.IN, unit=1.0 / unit_t
        )
        function.result_type = "int32"
        return function
    ...
    def get_spin_vector():
        ...
        function.addParameter(
            "spin_vec_x", dtype="float64", direction=function.OUT, unit=1.0 / unit_t
        )
        function.addParameter(
            "spin_vec_y", dtype="float64", direction=function.OUT, unit=1.0 / unit_t
        )
        function.addParameter(
            "spin_vec_z", dtype="float64", direction=function.OUT, unit=1.0 / unit_t
        )
        function.result_type = "int32"
        return function
    ...
    def set_spin_vector_dot():
        ...
        function.addParameter(
            "spin_vec_x_dot_external",
            dtype="float64",
            direction=function.IN,
            unit=1.0 / (unit_t**2),
        )
        function.addParameter(
            "spin_vec_y_dot_external",
            dtype="float64",
            direction=function.IN,
            unit=1.0 / (unit_t**2),
        )
    ...
    def set_orbital_vectors():
        ...
        function.addParameter(
            "e_vec_x", dtype="float64", direction=function.IN, unit=NO_UNIT
        )
        function.addParameter(
            "e_vec_y", dtype="float64", direction=function.IN, unit=NO_UNIT
        )
        function.addParameter(
            "e_vec_z", dtype="float64", direction=function.IN, unit=NO_UNIT
        )
        function.addParameter(
            "h_vec_x", dtype="float64", direction=function.IN, unit=unit_h
        )
        function.addParameter(
            "h_vec_y", dtype="float64", direction=function.IN, unit=unit_h
        )
        function.addParameter(
            "h_vec_z", dtype="float64", direction=function.IN, unit=unit_h
        )
        function.result_type = "int32"
        return function
    ...
    def set_orbital_elements():
        ...
        function.addParameter(
            "semimajor_axis", dtype="float64", direction=function.IN, unit=unit_l
        )
        function.addParameter(
            "eccentricity", dtype="float64", direction=function.IN, unit=NO_UNIT
        )
        function.addParameter(
            "inclination", dtype="float64", direction=function.IN, unit=NO_UNIT
        )
        function.addParameter(
    ...
    def get_orbital_elements():
        ...
        function.addParameter(
            "semimajor_axis", dtype="float64", direction=function.OUT, unit=unit_l
        )
        function.addParameter(
            "eccentricity", dtype="float64", direction=function.OUT, unit=NO_UNIT
        )
        function.addParameter(
            "inclination", dtype="float64", direction=function.OUT, unit=NO_UNIT
        )
        function.addParameter(
            "argument_of_pericenter",
            dtype="float64",
    ...
    def get_inclination_relative_to_parent():
        ...
        function.addParameter(
            "inclination_relative_to_parent",
            dtype="float64",
            direction=function.OUT,
            unit=NO_UNIT,
        )
    ...
    def get_de_dt():
        ...
        function.addParameter(
            "de_dt", dtype="float64", direction=function.OUT, unit=1.0 / unit_t
        )
        function.result_type = "int32"
        return function
    ...
    #     )
    #     function.addParameter(
    #         "position_x", dtype="float64", direction=function.IN, unit=unit_l
    #     )
    #     function.addParameter(
    #         "position_y", dtype="float64", direction=function.IN, unit=unit_l
    #     )
    #     function.addParameter(
    #         "position_z", dtype="float64", direction=function.IN, unit=unit_l
    #     )
    #     function.result_type = "int32"
    #     return function
    ...
    #     )
    #     function.addParameter(
    #         "position_x", dtype="float64", direction=function.OUT, unit=unit_l
    #     )
    #     function.addParameter(
    #         "position_y", dtype="float64", direction=function.OUT, unit=unit_l
    #     )
    #     function.addParameter(
    #         "position_z", dtype="float64", direction=function.OUT, unit=unit_l
    #     )
    #     function.result_type = "int32"
    #     return function
    ...
    #     )
    #     function.addParameter(
    #         "velocity_x", dtype="float64", direction=function.IN, unit=unit_l / unit_t
    #     )
    #     function.addParameter(
    #         "velocity_y", dtype="float64", direction=function.IN, unit=unit_l / unit_t
    #     )
    #     function.addParameter(
    #         "velocity_z", dtype="float64", direction=function.IN, unit=unit_l / unit_t
    #     )
    #     function.result_type = "int32"
    #     return function
    ...
    #     )
    #     function.addParameter(
    #         "velocity_x", dtype="float64", direction=function.OUT, unit=unit_l / unit_t
    #     )
    #     function.addParameter(
    #         "velocity_y", dtype="float64", direction=function.OUT, unit=unit_l / unit_t
    #     )
    #     function.addParameter(
    #         "velocity_z", dtype="float64", direction=function.OUT, unit=unit_l / unit_t
    #     )
    #     function.result_type = "int32"
    #     return function
    ...
    def set_root_finding_state():
        ...
        function.can_handle_array = True
        function.addParameter(
            "index_of_the_particle", dtype="int32", direction=function.IN, unit=NO_UNIT
        )
        function.addParameter(
        ...
        function.addParameter(
            "minimum_periapse_distance_has_occurred",
            dtype="bool",
            direction=function.IN,
            unit=NO_UNIT,
        )
        function.addParameter(
            "RLOF_at_pericentre_has_occurred",
            dtype="bool",
            direction=function.IN,
            unit=NO_UNIT,
        )
    ...
    def evolve_interface():
        function = LegacyFunctionSpecification()
        function.addParameter(
            "start_time", dtype="float64", direction=function.IN, unit=unit_t
        )
        function.addParameter(
            "time_step", dtype="float64", direction=function.IN, unit=unit_t
        )
        function.addParameter(
            "output_time", dtype="float64", direction=function.OUT, unit=unit_t
        )
        function.addParameter(
            "hamiltonian", dtype="float64", direction=function.OUT, unit=unit_e
        )
        function.addParameter(
            "flag", dtype="int32", direction=function.OUT, unit=NO_UNIT
        )
        function.addParameter(
            "error_code", dtype="int32", direction=function.OUT, unit=NO_UNIT
        )
        function.result_type = "int32"
        return function
    ...
    #     function = LegacyFunctionSpecification()
    #     function.addParameter(
    #         "value", dtype="int32", direction=function.OUT, unit=NO_UNIT
    #     )
    #     function.result_type = "int32"
    #     return function
    ...
    #     function = LegacyFunctionSpecification()
    #     function.addParameter(
    #         "value", dtype="int32", direction=function.IN, unit=NO_UNIT
    #     )
    #     function.result_type = "int32"
    #     return function
    ...
    #     function = LegacyFunctionSpecification()
    #     function.addParameter(
    #         "value", dtype="float64", direction=function.OUT, unit=NO_UNIT
    #     )
    #     function.result_type = "int32"
    #     return function
    ...
    #     function = LegacyFunctionSpecification()
    #     function.addParameter(
    #         "value", dtype="float64", direction=function.IN, unit=NO_UNIT
    #     )
    #     function.result_type = "int32"
    #     return function
...
class SecularMultiple(InCodeComponentImplementation):
    ...
    def __init__(self, **options):
        InCodeComponentImplementation.__init__(
            self, SecularMultipleInterface(**options), **options
        )
    ...
    def define_particle_sets(self, handler):
        ...
        handler.add_setter(
            "external_particles",
            "set_external_rdot_vectors",
            names=("rdot_vec_x", "rdot_vec_y", "rdot_vec_z"),
        )
        handler.add_getter(
            "external_particles",
            "get_external_rdot_vectors",
            names=("rdot_vec_x", "rdot_vec_y", "rdot_vec_z"),
        )
    ...
    def before_get_parameter(self):
        """
        Called every time just before a parameter is retrieved in using::
    ...
    def before_set_parameter(self):
        """
        Called every time just before a parameter is updated in using::
    ...
    def commit_particles(self):
        ...
        particles.add_vector_attribute(
            "spin_vec", ["spin_vec_x", "spin_vec_y", "spin_vec_z"]
        )
        particles.add_vector_attribute("e_vec", ["e_vec_x", "e_vec_y", "e_vec_z"])
        particles.add_vector_attribute("h_vec", ["h_vec_x", "h_vec_y", "h_vec_z"])

        self.external_particles.add_vector_attribute(
            "r_vec", ["r_vec_x", "r_vec_y", "r_vec_z"]
        )

        ### evaluate the initial hamiltonian ###
        time_step = 0.0 | units.Myr
        end_time, self.initial_hamiltonian, flag, error_code = self.evolve_interface(
    ...
    def evolve_model(self, end_time):
        ...
        end_time, self.hamiltonian, flag, error_code = self.evolve_interface(
            start_time, time_step
        )

        ### compute energy error ###
        self.relative_energy_error = numpy.fabs(
            (self.initial_hamiltonian - self.hamiltonian) / self.initial_hamiltonian
        )
